...
class Product{
    ...
    public function addAProduct($data){
      $this->db->query('INSERT INTO products(product_name,buying_price,selling_price,category_id,admin_id,image_url) VALUES (:product_name,:buying_price,:selling_price,:category_id,:admin_id,:image_url)');
      //Bind values
  ...
  public function editAProduct($data){
    $this->db->query('UPDATE products SET product_name =:product_name,buying_price=:buying_price,selling_price=:selling_price,category_id=:category_id,admin_id=:admin_id WHERE product_id=:product_id;');
    //Bind values
